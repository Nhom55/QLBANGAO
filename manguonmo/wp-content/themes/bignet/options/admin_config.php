<?php
    ...
    $opt_name = "bng_options";

    // This line is only for altering the demo. Can be easily removed.
    $opt_name = apply_filters( 'bng_options/opt_name', $opt_name );
    ...
    $args = array(
        ...
        'menu_title'           => __( 'BIGNET OPTIONS', 'redux-framework-demo' ),
        'page_title'           => __( 'BIGNET OPTIONS', 'redux-framework-demo' ),
    ...
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Cài Đặt Cơ Bản', 'redux-framework-demo' ),
        'id'               => 'basic',
        'desc'             => __( 'Chứa các quản trị cơ bản trong giao diện!', 'redux-framework-demo' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'desc'             => __( 'Chứa các quản trị về Logo, banner, liên hệ cơ bản.'),
        'fields'           => array(
            array(
                'id'       => 'logo',
                'type'     => 'media',
                'title'    => __( 'Logo', 'redux-framework-demo' ),
                'subtitle' => __( 'Thêm/Xóa/Sửa LOGO tại đây', 'redux-framework-demo' ),
                'desc'     => __( 'Thêm LOGO của bạn tại đây.', 'redux-framework-demo' ),
                'default'  => '1'// 1 = on | 0 = off
            ),
            array(
                'id'       => 'header-top-hotline',
                'type'     => 'text',
                'title'    => __( 'Hotline', 'redux-framework-demo' ),
                'subtitle' => __( 'Thêm/Xóa/Sửa Hotline tại đây', 'redux-framework-demo' ),
                'desc'     => __( 'Điền Hotline của bạn tại đây', 'redux-framework-demo' ),
                'default'  => '1'
            ),
            array(
                'id'       => 'header-top-email',
                ...
                'subtitle' => __( 'Thêm/Xóa/Sửa Email tại đây', 'redux-framework-demo' ),
                'desc'     => __( 'Điền Email của bạn tại đây', 'redux-framework-demo' ),
                'default'  => '1'
            ),
            array(
            ...
            array(
                ...
                'subtitle'         => __( 'Thêm/Xóa/Sửa Footer tại đây', 'redux-framework-demo' ),
                'customizer_width' => '500px',
                'desc'             => __( 'Sửa thông tin bản quyền Website','redux-framework-demo'),
                'default'  => 'Demo DEV',
            )),
    ) );
    Redux::setSection( $opt_name, array(
...
array(
    ...
    'options' => array(
        'Text'=>'icon1',
        'Text'=>'icon2',
        'Text'=>'icon3',), // key/value pair, value is the title
